package sprint4.PropertiesDemo;
...
public class PropertiesDemo extends JFrame {
    ...
    public PropertiesDemo()  {
        ...
        try{
            //p.load(new FileInputStream("src/sprint4/PropertiesDemo/DemoProperties.properties"));
            p.loadFromXML(new FileInputStream("src/sprint4/PropertiesDemo/Settings2.xml"));
        }
        catch (Exception e){
           e.printStackTrace();
        }
